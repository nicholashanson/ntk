...
TEST( IntegrationTest, DecryptTlsData_IsHttpRequest ) {
    ...
    decrypted_client_tls_records.erase( decrypted_client_tls_records.begin() );
    decrypted_client_tls_records.erase( decrypted_client_tls_records.begin() );
    ntk::print_vector( decrypted_client_tls_records.front().payload );
    auto request = ntk::get_http_request( decrypted_client_tls_records.front().payload );
    ntk::print_http_request( request );

    ASSERT_TRUE( ntk::is_http_request( decrypted_client_tls_records.front().payload )  );
}
...
TEST( IntegrationTest, DecryptTlsData_IsHttpResponse ) {
    ...
    ASSERT_TRUE( ntk::is_http_response( decrypted_server_tls_records.front().payload )  );
}
