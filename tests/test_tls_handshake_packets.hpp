...
namespace test_constants {
    ...
    inline const std::span<const uint8_t> tls_client_hello_span( tls_client_hello_packet );

    inline const auto tls_client_hello_bytes = tls_client_hello_span.subspan( 75 );

    inline const unsigned char tls_client_hello_cipher_suites[] = {
    ...
    inline const unsigned char tls_server_hello_record[] = {
